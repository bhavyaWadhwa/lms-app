...
/*
 * This is a union of tags reported by the parent component, and tags currently applied to users listed in the form. This allows the
 * form to suggest tags that haven't yet been persisted, but have been applied to at least one of the users in the list.
 */
