  ...
  <div>
    <div className="mb-6">
      <label
        ...
        <span className="mr-2"> <i className="fas fa-list text-base" /> </span>
        {"How do you want the user to complete the target?" |> str}
      </label>
             ...
             <div className="max-w-3xl mx-auto px-3">
                 ...
                 <div id="role" className="flex mt-4 ml-6">
                   <button
                     ...
                     <span className="text-sm">
                       {"All users must submit individually." |> str}
                     </span>
                   </button>
                   <button
               ...
               <div className="mb-6">
                 <label
                   ...
                   {"Do you have any completion instructions for the user?"
                    |> str}
