...
let featuredButton = (featured, send) =>
  <div className="flex items-center mt-5">
    <label
      className="block tracking-wide text-xs font-semibold mr-6"
      htmlFor="featured">
      {"Feature course in learnmax homepage?" |> str}
    </label>
    <div
      id="featured"
      className="flex toggle-button__group flex-shrink-0 rounded-lg overflow-hidden">
            ...
            <div className="max-w-2xl p-6 mx-auto">
              ...
              <div className="mt-5">
                ...
                <HelpIcon
                  ...
                  {"If specified, course will appear as closed to users on this date. Users will not be able to make any more submissions."
                   |> str}
                </HelpIcon>
                <DatePicker
              ...
              <div className="mt-5">
                ...
                <HelpIcon
                  ...
                  {"This only applies if your course has milestone modules that requires users to submit their work for review by coaches."
                   |> str}
                </HelpIcon>
                <div className="flex mt-2">
                  <button
                    ...
                    <div className="text-xs mt-2">
                      <div> {"Users can level up" |> str} </div>
                      <select
                  ...
                  <button
                    ...
                    <span className="text-xs">
                      {"Users can level up till the end of the course, without getting submissions reviewed."
                       |> str}
                    </span>
                  </button>
                  <button
                    ...
                    <span className="text-xs">
                      {"Users can level up only after getting submissions reviewed, and passing."
                       |> str}
                    </span>
                  </button>
                </div>
